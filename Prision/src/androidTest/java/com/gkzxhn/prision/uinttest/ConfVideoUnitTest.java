...
import com.gkzxhn.prision.testutils.Utils;
...
public class ConfVideoUnitTest {
    ...
    public ActivityTestRule mActivityTestRule=new ActivityTestRule<VConfVideoUI>
        ...
        protected Intent getActivityIntent() {
            ...
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_VCONFNAME,"张三24(18163657553)");
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_E164NUM,"18163657553");
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_MACKCALL,true);
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_JOINCONF,false);
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_VCONFQUALITY,0);
            result.putExtra(com.gkzxhn.prision.common.Constants.TERMINAL_VCONFDURATION,0);
            return result;
        }
    };
    @Before
