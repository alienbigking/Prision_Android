...
public class CallUserUnitTest {
    ...
    public ActivityTestRule mActivityTestRule=new ActivityTestRule<CallUserActivity>
        ...
        protected Intent getActivityIntent() {
            ...
            result.putExtra(com.gkzxhn.prision.common.Constants.EXTRA,"149");
            result.putExtra(com.gkzxhn.prision.common.Constants.EXTRAS,"18163657553");
            result.putExtra(com.gkzxhn.prision.common.Constants.EXTRA_TAB,"tttt");
            return result;
        }
    };
    @Before
