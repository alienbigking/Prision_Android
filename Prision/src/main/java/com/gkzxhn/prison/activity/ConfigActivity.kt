...
import kotlinx.android.synthetic.main.config_layout.config_layout_et_meeting_number
as etMeettingNumber
import kotlinx.android.synthetic.main.config_layout.config_layout_et_host_password
as etHostPassword
import kotlinx.android.synthetic.main.config_layout.config_layout_et_guest_password
as etGuestPassword
import kotlinx.android.synthetic.main.config_layout.config_layout_rg_usb
as rgUSB
...
as etTime
import kotlinx.android.synthetic.main.config_layout.config_layout_tv_account
as tvAccount
...
class ConfigActivity : SuperActivity() {
    ...
    private fun init() {
        ...
        //显示当前终端号
        tvAccount.setText( preferences.getString(Constants.USER_ACCOUNT, ""))
        //获取
